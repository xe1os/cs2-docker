...
# Start gameserver
${CS2_DIR}/game/cs2.sh -dedicated -game csgo -console -usercon -maxplayers ${MAXPLAYERS} -port ${PORT} +map ${MAP} +gametype ${GAME_TYPE} +ip ${IP} +gamemode ${GAME_MODE} +exec autoexec.cfg ${EXTRAARG}
